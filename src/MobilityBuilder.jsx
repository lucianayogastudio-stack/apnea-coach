...
const DEFAULT_EXERCISES = [
  // Chest & Shoulders
  { id:"chest-opener",      name:"Chest Opener Stretch",    category:"Chest & Shoulders", type:"duration" },
  { id:"doorway-stretch",   name:"Doorway Pec Stretch",     category:"Chest & Shoulders", type:"duration" },
  { id:"shoulder-circles",  name:"Shoulder Circles",        category:"Chest & Shoulders", type:"reps" },
  { id:"cross-body-stretch",name:"Cross-Body Shoulder Stretch",category:"Chest & Shoulders",type:"duration" },
  { id:"sleeper-stretch",   name:"Sleeper Stretch",         category:"Chest & Shoulders", type:"duration" },
  { id:"thread-needle",     name:"Thread the Needle",       category:"Chest & Shoulders", type:"reps" },
  // Spine & Back
  { id:"cat-cow",           name:"Cat-Cow",                 category:"Spine & Back",      type:"reps" },
  { id:"thoracic-rotation", name:"Thoracic Rotation",       category:"Spine & Back",      type:"reps" },
  { id:"childs-pose",       name:"Child's Pose",            category:"Spine & Back",      type:"duration" },
  { id:"seated-twist",      name:"Seated Spinal Twist",     category:"Spine & Back",      type:"duration" },
  { id:"cobra",             name:"Cobra Stretch",           category:"Spine & Back",      type:"duration" },
  { id:"foam-roll-thoracic",name:"Foam Roll — Thoracic",    category:"Spine & Back",      type:"duration" },
  { id:"sphinx",            name:"Sphinx Pose",             category:"Spine & Back",      type:"duration" },
  // Hips & Glutes
  { id:"hip-flexor",        name:"Hip Flexor Stretch",      category:"Hips & Glutes",     type:"duration" },
  { id:"pigeon-pose",       name:"Pigeon Pose",             category:"Hips & Glutes",     type:"duration" },
  { id:"figure-4",          name:"Figure-4 Stretch",        category:"Hips & Glutes",     type:"duration" },
  { id:"frog-stretch",      name:"Frog Stretch",            category:"Hips & Glutes",     type:"duration" },
  { id:"hip-circles",       name:"Hip Circles",             category:"Hips & Glutes",     type:"reps" },
  { id:"90-90",             name:"90/90 Hip Stretch",       category:"Hips & Glutes",     type:"duration" },
  { id:"glute-bridge",      name:"Glute Bridge Hold",       category:"Hips & Glutes",     type:"duration" },
  // Legs & Ankles
  { id:"hamstring-stretch", name:"Hamstring Stretch",       category:"Legs & Ankles",     type:"duration" },
  { id:"quad-stretch",      name:"Quad Stretch",            category:"Legs & Ankles",     type:"duration" },
  { id:"calf-stretch",      name:"Calf Stretch",            category:"Legs & Ankles",     type:"duration" },
  { id:"ankle-circles",     name:"Ankle Circles",           category:"Legs & Ankles",     type:"reps" },
  { id:"seated-hamstring",  name:"Seated Hamstring Stretch",category:"Legs & Ankles",     type:"duration" },
  { id:"adductor-stretch",  name:"Adductor / Groin Stretch",category:"Legs & Ankles",     type:"duration" },
  { id:"ankle-dorsiflexion",name:"Ankle Dorsiflexion",      category:"Legs & Ankles",     type:"reps" },
  // Neck & Jaw
  { id:"neck-rolls",        name:"Neck Rolls",              category:"Neck & Jaw",        type:"reps" },
  { id:"neck-side-stretch", name:"Neck Side Stretch",       category:"Neck & Jaw",        type:"duration" },
  { id:"chin-tuck",         name:"Chin Tuck",               category:"Neck & Jaw",        type:"reps" },
  { id:"jaw-relaxation",    name:"Jaw Relaxation",          category:"Neck & Jaw",        type:"duration" },
  { id:"tmj-release",       name:"TMJ Release",             category:"Neck & Jaw",        type:"duration" },
  // Breathwork & Diaphragm
  { id:"diaphragm-stretch", name:"Diaphragm Stretch",       category:"Breathwork",        type:"duration" },
  { id:"intercostal-stretch",name:"Intercostal Stretch",    category:"Breathwork",        type:"duration" },
  { id:"rib-expansion",     name:"Rib Expansion Breathing", category:"Breathwork",        type:"duration" },
  { id:"yoga-flow",         name:"Yoga Flow",               category:"Breathwork",        type:"duration" },
  { id:"belly-breathing",   name:"Belly Breathing",         category:"Breathwork",        type:"duration" },
  // Full Body
  { id:"sun-salutation",    name:"Sun Salutation",          category:"Full Body",         type:"reps" },
  { id:"world-greatest",    name:"World's Greatest Stretch",category:"Full Body",         type:"reps" },
  { id:"inchworm",          name:"Inchworm",                category:"Full Body",         type:"reps" },
  { id:"dynamic-warmup",    name:"Dynamic Warm-Up Flow",    category:"Full Body",         type:"duration" },
  { id:"foam-roll-full",    name:"Full Body Foam Roll",     category:"Full Body",         type:"duration" },
];

const CATEGORIES = ["All", "Chest & Shoulders", "Spine & Back", "Hips & Glutes", "Legs & Ankles", "Neck & Jaw", "Breathwork", "Full Body"];
const SET_TYPES = [
    ...
    <div style={{marginBottom:24}}>
      ...
      {!isClient&&(
        <div style={{display:"flex",gap:8,marginTop:4}}>
          <button onClick={()=>addBlock("single")}
            style={{padding:"8px",borderRadius:8,border:"1.5px solid #f0f0ec",background:"#f0f0ec",color:"#555",fontSize:12,fontWeight:600,cursor:"pointer",fontFamily:"inherit",width:"100%"}}
...
// ── Main Component ────────────────────────────────────────────────────────────
export default function MobilityBuilder({ initialData, onSave, isClient: isClientProp , difficultyPicker=null}) {
      ...
      <div style={{marginBottom:16}}>
        {isClient ? (
          ...
          <input value={workoutName} onChange={e=>setWorkoutName(e.target.value)}
            ...
            placeholder="Session name (e.g. Morning Mobility — Hips & Spine)..." />
        )}
