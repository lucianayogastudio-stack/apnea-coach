            ...
            <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",marginBottom:22}}>
              ...
              <div style={{display:"flex",gap:8}}>
                <button onClick={()=>generateWeekPDF(weekDates, sessions.filter(s=>s.clientId===activeClient.id), activeClient.name, "")}
                  style={{background:"#f0f0ec",border:"none",borderRadius:8,padding:"8px 13px",fontSize:12,fontWeight:600,color:"#555",cursor:"pointer",fontFamily:"inherit"}}>📄 Week PDF</button>
